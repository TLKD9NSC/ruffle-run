const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./ruffle_web-wasm_extensions-BxshzwO1.js","./ruffle-imports-CztXuSei.js","./ruffle_web-Co75J8jD.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Lf=re,If=Symbol.for("react.element"),Mf=Symbol.for("react.fragment"),Nf=Object.prototype.hasOwnProperty,$f=Lf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,qf={key:!0,ref:!0,__self:!0,__source:!0};function Uu(e,n,t){var r,i={},o=null,a=null;t!==void 0&&(o=""+t),n.key!==void 0&&(o=""+n.key),n.ref!==void 0&&(a=n.ref);for(r in n)Nf.call(n,r)&&!qf.hasOwnProperty(r)&&(i[r]=n[r]);if(e&&e.defaultProps)for(r in n=e.defaultProps,n)i[r]===void 0&&(i[r]=n[r]);return{$$typeof:If,type:e,key:o,ref:a,props:i,_owner:$f.current}}Ui.Fragment=Mf;Ui.jsx=Uu;Ui.jsxs=Uu;Du.exports=Ui;var j=Du.exports,Zo={},Bu={exports:{}},Ae={},Vu={exports:{}},Hu={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function n(_,A){var D=_.length;_.push(A);e:for(;0<D;){var Y=D-1>>>1,oe=_[Y];if(0<i(oe,A))_[Y]=A,_[D]=oe,D=Y;else break e}}function t(_){return _.length===0?null:_[0]}function r(_){if(_.length===0)return null;var A=_[0],D=_.pop();if(D!==A){_[0]=D;e:for(var Y=0,oe=_.length,Or=oe>>>1;Y<Or;){var Nn=2*(Y+1)-1,co=_[Nn],$n=Nn+1,Lr=_[$n];if(0>i(co,D))$n<oe&&0>i(Lr,co)?(_[Y]=Lr,_[$n]=D,Y=$n):(_[Y]=co,_[Nn]=D,Y=Nn);else if($n<oe&&0>i(Lr,D))_[Y]=Lr,_[$n]=D,Y=$n;else break e}}return A}function i(_,A){var D=_.sortIndex-A.sortIndex;return D!==0?D:_.id-A.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var s=[],u=[],p=1,h=null,m=3,g=!1,y=!1,S=!1,F=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(_){for(var A=t(u);A!==null;){if(A.callback===null)r(u);else if(A.startTime<=_)r(u),A.sortIndex=A.expirationTime,n(s,A);else break;A=t(u)}}function v(_){if(S=!1,f(_),!y)if(t(s)!==null)y=!0,so(x);else{var A=t(u);A!==null&&uo(v,A.startTime-_)}}function x(_,A){y=!1,S&&(S=!1,d(E),E=-1),g=!0;var D=m;try{for(f(A),h=t(s);h!==null&&(!(h.expirationTime>A)||_&&!L());){var Y=h.callback;if(typeof Y=="function"){h.callback=null,m=h.priorityLevel;var oe=Y(h.expirationTime<=A);A=e.unstable_now(),typeof oe=="function"?h.callback=oe:h===t(s)&&r(s),f(A)}else r(s);h=t(s)}if(h!==null)var Or=!0;else{var Nn=t(u);Nn!==null&&uo(v,Nn.startTime-A),Or=!1}return Or}finally{h=null,m=D,g=!1}}var P=!1,z=null,E=-1,w=5,b=-1;function L(){return!(e.unstable_now()-b<w)}function ze(){if(z!==null){var _=e.unstable_now();b=_;var A=!0;try{A=z(!0,_)}finally{A?$e():(P=!1,z=null)}}else P=!1}var $e;if(typeof c=="function")$e=function(){c(ze)};else if(typeof MessageChannel<"u"){var Ee=new MessageChannel,gf=Ee.port2;Ee.port1.onmessage=ze,$e=function(){gf.postMessage(null)}}else $e=function(){F(ze,0)};function so(_){z=_,P||(P=!0,$e())}function uo(_,A){E=F(function(){_(e.unstable_now())},A)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){y||g||(y=!0,so(x))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):w=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return t(s)},e.unstable_next=function(_){switch(m){case 1:case 2:case 3:var A=3;break;default:A=m}var D=m;m=A;try{return _()}finally{m=D}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,A){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var D=m;m=_;try{return A()}finally{m=D}},e.unstable_scheduleCallback=function(_,A,D){var Y=e.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?Y+D:Y):D=Y,_){case 1:var oe=-1;break;case 2:oe=250;break;case 5:oe=1073741823;break;case 4:oe=1e4;break;default:oe=5e3}return oe=D+oe,_={id:p++,callback:A,priorityLevel:_,startTime:D,expirationTime:oe,sortIndex:-1},D>Y?(_.sortIndex=D,n(u,_),t(s)===null&&_===t(u)&&(S?(d(E),E=-1):S=!0,uo(v,D-Y))):(_.sortIndex=oe,n(s,_),y||g||(y=!0,so(x))),_},e.unstable_shouldYield=L,e.unstable_wrapCallback=function(_){var A=m;return function(){var D=m;m=A;try{return _.apply(this,arguments)}finally{m=D}}}})(Hu);Vu.exports=Hu;var Wf=Vu.exports;/**
 * @license React
